...
public class NetworkDB implements NetworkDAO {
    ...
    public void insert(StressNetwork network) {
        try (Connection conn = DBConnection.getConnection(); PreparedStatement query = conn.prepareStatement(QueryBuilder.insert(TABLE, List.of(COL_ID, COL_NAME)))) {
    ...
    public void delete(String id) {
        try (Connection conn = DBConnection.getConnection();
            ...
            throw new DataBaseAccessException("Something went wrong while deleting a network", ex);
        }
    }
    ...
    public List<NetworkInfo> loadInfoAndIdsForAllNetworks() {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement query = conn.prepareStatement(QueryBuilder.selectAll(TABLE, COL_ID, COL_NAME))) {
    ...
    public void update(StressNetwork network) {
        try (Connection conn = DBConnection.getConnection(); PreparedStatement query = conn.prepareStatement(QueryBuilder.updateCols(TABLE, COL_ID, List.of(COL_NAME)))) {
